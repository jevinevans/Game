...
Last Updated: 4.1.2022 <!-- Update with previous log date -->
Version: 0.4.8 
...
- [ ] Stats level up function __Will postpone this feature until after integration - 3.23.2022__
...
Types | Turn type constants into tuples that way the the str or int value can be used | __To Do__ | 4.5.2022
