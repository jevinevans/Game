...
Used Copilot to establish base game function, need to integrate abilities and mod processes into format to work with class data
...
- Updated all Managers into objects and centralized functionality
- Initial Base game functions
