# FUN Command Line Game Log - 06.30.2021 - 07.04.2021
<!-- Update: Current Log date -->

Last Updated: 07.04.2021<!-- Update with previous log date -->
...
- Updated CodeTest Format

### 07.04.2021

- Update CodeTest_Armor Table
- updated Equipment and Armor code test names
- Update Armor.h getters by adding a getVal() function to the Slot struct. Ensures return of equipment and not the Slot object
