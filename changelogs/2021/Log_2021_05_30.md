# FUN Command Line Game Log - 05.30.2021
<!-- Update: Current Log date -->

Last Updated: 05.28.2021<!-- Update with previous log date -->
...
- Created an untested solution for Armor print out to test other key feaures. Currently FUNCGL works, but when reading and writing to the TempEList it adds a second set of trousers and not sure if this is from Linkedlist.h or Functions.cpp.
...
FUNCLG | __**Update 5.30.2021__: Code is run and testing out, but new issue with the inventory print and reading.  __Original:__ Code is not printing out everything and stops before the dequip, issue might be with Equipment Array Weps or may be with Armor Include, working in progress. | __Testing__ | +0.0.0 | Unknown | 5.30.2021
...
CodeTest | __**Update 5.30.2021:__ May have fixed deletion issues, but having issue with reading and printing from lists. __Original:__ Remove linkedlists from all testing because there is an issue with the deletion of them | __Testing__ | +0.0.0 | 5.28.2021 | 5.30.2021
