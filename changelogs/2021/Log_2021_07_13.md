# FUN Command Line Game Log - 07.13.2021 - 07.17.2021
<!-- Update: Current Log date -->

Last Updated: 07.16.2021<!-- Update with previous log date -->
...
- For proper exporting and importing of character/game info decided to use json format.
  - Considering this, the code will be converted into python and the old code deprecated.

### 07.15.2021

- Complete equipment convertion and created a test case.

### 07.16.2021

- Started armor class conversion and created outline for testing
  - created init, str, equip, dequip, printToFile
  - will create tests soon
- Updated utils.getItemDescription format
- Updated core.equipment \_\_str\_\_ function
- created script to run all unittests
- removed pycache files and directories from print in Gaame Directories
