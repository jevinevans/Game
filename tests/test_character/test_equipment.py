...
from FUNCLG.utils.types import ARMOR_TYPES, WEAPON_TYPES, ITEM_TYPES
...
def test_equipment_export():
    ...
    assert item.export() == {"name":"Export Test", "description":"Export Test Description", "item_type":0, "armor_type":0}
...
def test_weaponequipment_get_item_description(weaponequipment_all_types, weaponequipment_description_expectations):
    for weapon in weaponequipment_all_types.values():
