# FUN Command Line Game Log - 1.1.2022 - 1.31.2022
<!-- Update: Current Log date -->

Last Updated: 1.22.2022 <!-- Update with previous log date -->
Version: 0.2.5 
...
#### In Progress
- Working to complete Roles class
  - need to add 4 functions
  - test class 

#### Added
- Abilities class
- Added abilities test 

#### Changed
- Updated runTest.sh to include codeQuality.sh and results will appear in teh report to be worked on.
  - removed black and isort because they are in codequality
  - added specifications in pyproject

- Changed the core module to be the character module since all parts are just to build the character and not the core of the game.

- equipment init item,wep,arm types from string to int
  - updated tests

#### Fixed
- fixing code errors in equipment from codequality corrections
- fixing issues from equipment init type change

#### Informational
- updated formats of test, and included output prints for quick looks
- Code Quality
