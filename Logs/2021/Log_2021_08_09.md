# FUN Command Line Game Log - 08.09.2021 - 08.20.2021
<!-- Update: Current Log date -->

Last Updated: 08.09.2021<!-- Update with previous log date -->
...
- Working on Flake8 errors (Completed: 60)
  - updated flake8 ignores
- updated ignore values in scan directories
- fixed issues with type where zero was being none
