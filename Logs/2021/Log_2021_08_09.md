...
Last Updated: 08.14.2021 <!-- Update with previous log date -->
Version: 0.9.1  <!-- Update version number when changes mage-->

Total Tests: 10
Flake8 Errors: 3 -> 3 <!-- Start -> End  -->
...
- Working on equipment tests: details, export1, export2
- creating type methods in equipment class to streamline calls, and allow for just calling the method instead of having to pass it into something
  - created: getItemType, getWeaponType, getArmorType, and getItemDescription for equipment objects
- completed current equipment tests
- working on armor tests
  - working on: printToFile test (complete)
- updated equipment export method to just export the dict of object for self and higher objects
- updated armor export method to call equipment exports to proper serialize into json file
- installed flake8-fixme to locate fixme/To Do items
