...
FUNCLG | __Update 5.30.2021__: Code is run and testing out, but new issue with the inventory print and reading. <br />  __Original:__ Code is not printing out everything and stops before the dequip, issue might be with Equipment Array Weps or may be with Armor Include, working in progress. | __In Progress__ | +0.0.0 | Unknown | 5.30.2021
