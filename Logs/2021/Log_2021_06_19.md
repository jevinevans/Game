# FUN Command Line Game Log - 06.19.2021 - 06.26.2021
<!-- Update: Current Log date -->

Last Updated: 06.22.2021<!-- Update with previous log date -->
...
- Update Scan_Directories format to be clean __6.19.2021__
...
---|---|---|---|---|---
Armor | __Updated 6.22.2021:__ Method is in testing <br />__Original:__ Create printToFile function <ul><li>Test Method</li><li>Document/Annotate Method</li></ul> | __Completed__ | +0.0.1 | 7.3.2020 | 5.30.2021
Roles | Update format for Role, power, and stats printToFile | __In Progress__ | +0.0.1 | 5.28.2021 | 6.22.2021
Functions | Inventory read in is reading a final object twice and prints twices, need to find the reason why | __In Progress__ | +0.0.0 | 5.30.2021 | 5.30.2021
FUNCLG | __Update 5.30.2021__: Code is run and testing out, but new issue with the inventory print and reading.  __Original:__ Code is not printing out everything and stops before the dequip, issue might be with Equipment Array Weps or may be with Armor Include, working in progress. | __Testing__ | +0.0.0 | Unknown | 5.30.2021
Armor | Create printToFile function <ul><li>Test Method</li><li>Document/Annotate Method</li></ul> | __Tesing__ | +0.0.1 | 7.3.2020 | 5.30.2021
Armor | Testing new Armor printToFile method and will update Codetest log (linked to FUNCLG below)| __Testing__ | +0.0.0 | 5.30.2021 | 5.30.2021
...
CodeTests | Combine code test for each include into one for each and just print out different number of tests and update logs to match standard format, also update file result names and possibly the locations | __In Progress__ | +0.0.0 | 5.28.2021 | 5.28.2021
