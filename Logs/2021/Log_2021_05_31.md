...
- Creating a test CodeTest for the Function.cpp file to test issues with functions.
  - Tested printToFile Equipment
- Working to simplify some of the printout as well and optimizing output
