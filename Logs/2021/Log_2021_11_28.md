...
- !!!! Need to rework log TODOs, its a mess and not clear on what is happening
- Conversion from C++ to Python
- Working Game by 2021 (end of year?!?!?!?)
...
### Road to Next Version 0.3.0
+ 0.0.1 - Add logging (error, info, debug) -> 0.2.1
+ 0.1 - Abilities -> 0.3.0
  + Test cases
+ 0.1 - Roles -> 0.4.0
  + Test Cases
