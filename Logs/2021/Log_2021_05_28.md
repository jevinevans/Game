...
<!-- Status: To Do, In Progress, On Hold, Completed, Remove  -->
...
Equipment | Stats Integration - equipment objects need a Stats object and ways to update/change them <ul><li>Create Code Test</li></ul> | __In Progress__ | +0.0.1 | 7.3.2020 | 5.28.2021
Armor | Annotate function methods | __To Do__ | +0.0.1 | 5.29.2020 | 5.28.2021
...
- [x] Updated format style of stats print out - Completed
