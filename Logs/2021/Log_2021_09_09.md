# FUN Command Line Game Log - 09.09.2021 - 09.18.2021
<!-- Update: Current Log date -->

Last Updated: 09.09.2021 <!-- Update with previous log date -->
...
+0.1.x.x is for current feature version updates including additions/removal/revamp of methods or parts (general idea of things)
+0.0.1.x is for minor changes to things like bug fixes, additions to current methods, minor removal, or minor optimization, creating new test script files
+0.0.0.1 is for spelling errors, creation or change to other scripts not directly involved in main project, completing or editing a test case
 -->
...
- Updated armor.dequip error handling for integer values +0.0.1.0 -> 0.2.2.7
- updated runTest script to include output on process that are happening +0.0.0.1 -> 0.2.2.8
- Working on test.armor.test_dequip +0.0.0.1 -> ????? (On completion)
  - Completed test_armor.test_dequip.1.a
  - Completed test_armor.test_dequip.1.b
  - Completed test_armor.test_dequip.2.a
  - Completed test_armor.test_dequip.2.b
  - Completed test_armor.test_dequip.2.c
...
All (Errors) | Create or use an error type that will raise and return an error value that is handled when something is wrong | __TO DO__ | +0.1.0.0 | 09.10.2021 | 09.10.2021
Logging | Need to set up logging for different information and events that happen in the game and save to a file for evaluation | __TO DO__ | +0.1.0.0 | 09.10.2021 | 09.10.2021
------------------------------  
