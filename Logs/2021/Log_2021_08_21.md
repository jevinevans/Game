...
Version: 0.2.1.2 <!-- Update version number when changes mage-->
<!-- Verions Additions 
...
- completed test_armor.test_str +0.0.0.1 -> 0.2.1.2

## Important Items

------------------------------

- [ ] Need to validate and find a way to copy equipment objects instead of passing them
