...
Last Updated: 08.26.2021 <!-- Update with previous log date -->
Version: 0.9.1.1  <!-- Update version number when changes mage-->
<!-- Verions Additions 
+1.x.x.x is for major project wide changes like adding a whole new concept/face change
+0.1.x.x is for current feature version updates including additions/removal/revamp of parts
+0.0.1.x is for minor changes to things like bug fixes
+0.0.0.1 is for spelling errors, log changes, creation or change to other scripts not directly involved in main project
 -->
...
- added armorType validations for object initialization
...
---|---|---|---|---|---
Project | Create a runTest.bat to run the code tests | __Completed__ | +0.0.0.1 4.19.2021
