...
Version: 0.2.1.9 <!-- Update version number when changes mage-->
<!-- Verions Additions 
...
- Completed test_armor.test_equip.1 +0.0.0.1 -> 0.2.1.5
- Completed test_armor.test_equip.2 +0.0.0.1 -> 0.2.1.6
- Completed test_armor.test_equip.3 +0.0.0.1 -> 0.2.1.7
- piped the results from flake8 into sort +0.0.0.1 -> 0.2.1.8
- fixed splling error for test_equipment.export +0.0.0.1 -> 0.2.1.9
